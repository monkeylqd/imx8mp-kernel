...
static int mxc_isi_source_fmt_init(struct mxc_isi_cap_dev *isi_cap)
{
	...
	src_fmt.which = V4L2_SUBDEV_FORMAT_ACTIVE;
	src_fmt.format.code = MEDIA_BUS_FMT_SBGGR8_1X8;
...
static const struct v4l2_ioctl_ops mxc_isi_capture_ioctl_ops = {
	...
	.vidioc_try_fmt_vid_cap		= mxc_isi_cap_try_fmt_mplane,
	.vidioc_s_fmt_vid_cap		= mxc_isi_cap_s_fmt_mplane,
	.vidioc_g_fmt_vid_cap		= mxc_isi_cap_g_fmt_mplane,
